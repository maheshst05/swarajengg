...
//             <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 bg-white shadow-lg rounded-lg">
//                 <div className="px-4 py-6 sm:px-6 lg:px-8">
//                     <h2 className="text-3xl font-bold text-gray-800" data-aos="fade-up">Who We Are</h2>
